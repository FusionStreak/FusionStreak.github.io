...
export const projects: Project[] = [
  ...
  },
  {
    title: 'BearBasket',
    description:
      'BearBasket is an open-source grocery list app, focused on simplicty and ease of use.',
    longDescription: [
      'Simple and intuitive user interface for quick grocery list management',
